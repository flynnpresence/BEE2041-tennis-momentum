...
Requires Python 3.10+ (tested on 3.12.7), pip, and [Quarto](https://quarto.org) 1.9+ (tested on 1.9.37) installed on your system. Note: pandas 3.0.1 requires Python ≥ 3.10. The download step requires an internet connection to fetch raw data from GitHub.
