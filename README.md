...
**Finding:** Break points generate a hangover effect across both tours (ATP: -0.0474, WTA: -0.0171). Tiebreaks diverge by tour: positive in the ATP (+0.0278) and strongly negative in the WTA (-0.0933, based on 207 treated observations). The ATP effects partially offset in aggregate, explaining why prior studies reached conflicting conclusions.
