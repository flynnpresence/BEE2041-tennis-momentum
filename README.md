...
**Finding:** Break points produce a large positive effect on the next point in both tours (ATP: +0.1362, 95% CI [0.1071, 0.1602]; WTA: +0.0671, 95% CI [0.0270, 0.0943]), driven by the serving transition that follows a break point win rather than psychological momentum. Tiebreaks are null in both tours (ATP: +0.0072, 95% CI [-0.023, 0.044]; WTA: +0.0024, 95% CI [-0.085, 0.066], based on a smaller 209 treated observations). The combined ATEs (ATP: +0.0888, WTA: +0.0550) are dominated by the more frequent break point effect, explaining why pooled analyses reach conflicting conclusions.

A matched-comparison robustness check sharpens this: server game points (the mirror-image score states — same high stakes, but winning transfers serve to the *opponent* rather than the winner) produce the opposite sign, on both tours (ATP: -0.1398, 95% CI [-0.1526, -0.1130]; WTA: -0.0581, 95% CI [-0.0923, -0.0318]). The effect's sign tracks which player serves next, not who won the point — evidence that the effect is structural rather than stakes- or belief-driven. See `methodology.md` §7a for the full argument.
