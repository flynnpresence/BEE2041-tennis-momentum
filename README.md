...
**Finding:** Break points produce a large positive effect on the next point in both tours (ATP: +0.1312, 95% CI [0.1069, 0.1588]; WTA: +0.0646, 95% CI [0.0273, 0.0948]), driven by the serving transition that follows a break point win rather than psychological momentum. Tiebreaks are null in both tours (ATP: -0.0066, 95% CI [-0.029, 0.047]; WTA: -0.0091, 95% CI [-0.091, 0.074], based on a smaller 209 treated observations). The combined ATEs (ATP: +0.0844, WTA: +0.0478) are dominated by the more frequent break point effect, explaining why pooled analyses reach conflicting conclusions.

A matched-comparison robustness check sharpens this: server game points (the mirror-image score states — same high stakes, but winning transfers serve to the *opponent* rather than the winner) produce the opposite sign, on both tours (ATP: -0.1394, 95% CI [-0.1502, -0.1111]; WTA: -0.0725, 95% CI [-0.0932, -0.0276]). The effect's sign tracks which player serves next, not who won the point — evidence that the effect is structural rather than stakes- or belief-driven. See `methodology.md` §7a for the full argument.
...
- **VIF Check:** A Variance Inflation Factor check confirmed no problematic multicollinearity among control variables (maximum score 1.185; VIF above 10 indicates problematic overlap).
