...
format:
  html:
    ...
    include-in-header:
      text: |
        <meta name="description" content="An analysis of 56,253 points from volunteer-charted matches across all four 2023 Grand Slams reveals that the next-point win probability after a break point is elevated by a structural serving advantage rather than psychological momentum. Tiebreaks, where that mechanism is absent, produce a null effect in the ATP and a negative effect in the WTA.">
...
The cumulative match tracker (CUSUM) dominates. Across both tours, accumulated match drift (what CUSUM captures: the cumulative gap between actual and average performance) accounts for 56% of the model's weight, with baseline player rank and rolling win percentage accounting for most of the remainder.
