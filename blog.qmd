...
The most striking feature is where the line crosses zero. In both tours, roughly the bottom third of players by TBOE sit in negative territory, the middle third cluster near zero, and the top third show positive values. If tiebreak performance were driven by psychological resilience, you would expect to see a handful of players with dramatically elevated scores and a long flat tail near zero. What you actually see is a smooth, near-linear progression with no such outliers. The data does not support the idea of a clutch gene. It supports the idea of a normal distribution of variation around a skill-driven baseline.
...
I define a high-leverage win as a point where the player faced a break point or tiebreak situation and won it. This follows directly from the academic literature. Gilovich et al. (1985) and Miller and Sanjurjo (2018) both define momentum as success breeding success, not merely exposure to pressure.
...
The first chart shows the estimated causal effect for every observation in the dataset, plotted against player ranking. The scatter is wide, with individual estimates ranging from -0.35 to +0.40, but the trend line tells a consistent story. In both the ATP and WTA, the trend sits at or below zero across all ranking levels, dipping more noticeably for lower-ranked players. Top-ranked players show no meaningful positive momentum effect. Neither do qualifiers. The combined picture is negative across the board.
...
The combined causal effect of winning a pressure point is -0.0162 for the ATP and -0.0173 for the WTA. Both are negative. Both are precise.

If we stopped here, the debate would be over. The hot hand is a fallacy. But remember, this combined number treats all high-leverage moments as identical. What happens if we split the two types of pressure apart?
...
**Average Treatment Effect of Winning a High-Leverage Point**
...
Winning a break point generates a hangover effect in both tours. The ATP estimate is -0.0242 and the WTA estimate is -0.0164, both negative. Converting a break point appears to slightly reduce the probability of winning the next point. Break points do not generate momentum. They generate a small but measurable drag.
...
This also explains why the combined number is negative. Break points are far more common than tiebreaks: 23.5% of all ATP points are break points, compared to just 3.5% in tiebreaks. The hangover effect happens more often, so it dominates the aggregate. When all high-leverage moments are treated as identical, the tiebreak momentum signal gets buried.

The WTA tiebreak estimate should be read with some caution. Only 197 WTA tiebreak observations met the treatment definition, compared to 646 in the ATP. The direction is consistent, but the ATP finding carries more statistical weight.

Two opposite effects have been cancelling each other out in every previous study that treated pressure moments as a single category. This is why the hot hand debate in tennis has never been resolved. Both sides were right about different things.
...
What most shapes whether the momentum effect is large or small is the accumulated drift of performance across the entire match. Not a sudden burst of form over the last four points. Not even the last ten. The variable that matters is how far a player has drifted from their own average across the whole match up to that point.

This connects back to the core insight of Gilovich, Vallone and Tversky. Human observers are not entirely wrong to perceive momentum as a force. They are wrong about where it comes from. It is not generated by a single dramatic point or a short winning streak. It accumulates slowly across the match, embedded in the overall trajectory rather than in any discrete psychological breakthrough.

## The Uncomfortable Conclusion

Momentum in tennis is not universal. It operates in opposite directions depending on context. Winning a break point reduces the probability of winning the next point. Winning a tiebreak point increases it. The break point effect is a hangover, the opposite of what every commentator assumes. The tiebreak effect is genuine positive momentum, exactly what crowds expect, but only in that specific context. These two effects are real, opposite in sign, and have been cancelling each other out in every aggregate analysis that treated all pressure moments as identical. That includes the studies that found no hot hand. That includes the studies that found one.
...
I should be honest about what this analysis cannot do. One season of Grand Slam data skews toward elite broadcast matches. I have no physiological data, no fatigue measures, nothing that captures momentum invisible to point-level scoring. Winning a high-leverage point is not purely random; it may reflect an unobserved player state that shapes both the current and next point simultaneously. The standard errors here are descriptive approximations, a consequence of the memory constraints that required stratified subsampling, and the conclusions rest on consistency across specifications rather than any single confidence interval. I also only test immediate point-to-point effects. Momentum may operate over longer stretches of a match that this analysis does not reach.

But the picture is clearer than it has ever been at this scale. For forty years, researchers have argued about whether the hot hand exists. The evidence here suggests they may have been asking too broad a question. It exists in tiebreaks. It runs in reverse at break points. And because break points happen roughly seven times more often than tiebreaks at Grand Slams, the positive effect has always been buried under the negative one.
