...
::: {.content-visible when-format="html"}
<iframe src="outputs/interactive_tboe.html" width="100%" height="470" frameborder="0" scrolling="no"></iframe>
:::
...
![Causal effect of winning a high-leverage point, across player rankings](outputs/output4_cate_plot.png){width=100%}
...
![Model results, logistic regression and causal forest estimates](outputs/output5_model_table.png){width=85%}
...
![Causal Forest feature importance](outputs/output6_feature_importance.png){width=100%}
...
This mirrors and extends the core insight of Gilovich, Vallone and Tversky — human observers are not entirely wrong to perceive momentum as a force, but they misattribute it. It is not generated by a single dramatic point, but accumulates across the match, embedded in the cumulative trajectory rather than in discrete psychological breakthroughs.
